...
namespace TwitterSearch.Views
{
    public partial class Search : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                SearchBox.Text = NavigationContext.QueryString["term"];
                DoSearch();
            }
        }
        ...
        private void DoSearch() 
        {
            if (!string.IsNullOrEmpty(SearchBox.Text))
            {
                ...
                string lastId = Helper.GetLastTweetId(SearchBox.Text);
                proxy.OpenReadAsync(new Uri(String.Format(SEARCH_URI, SearchBox.Text, lastId)));
                SearchBox.ItemsSource = Helper.GetSearchHistory();
            }
        }
        ...
        private string GetTweetId(String tweetId)
        {
            ...
            {
                //lastId = parts[2];
                Helper.SetLastTweetId(SearchBox.Text, parts[2]);
            }
